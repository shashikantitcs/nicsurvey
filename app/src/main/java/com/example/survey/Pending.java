...
import com.example.survey.Adapter.PendingAdapter;
...
public class Pending extends AppCompatActivity {
    ...
    private ArrayList<PendingModel> pendingModelArrayList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        survaylist("getAllSurvey",emp_id,"1");
    }
                    ...
                    if (response.isSuccessful()) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < getstatus.length(); i++) {
                                ...
                                pendingModel.setName(jsonObject.optString("name"));
                                pendingModel.setHousenumber(jsonObject.getString("house_no"));


                                pendingModelArrayList.add(pendingModel);
                            }
                            pendingAdapter = new PendingAdapter(getApplicationContext(), pendingModelArrayList);
                            recycler_view.setAdapter(pendingAdapter);
