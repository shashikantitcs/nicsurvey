...
import com.example.survey.Adapter.RejectedAdapter;
...
public class Rejected extends AppCompatActivity {
    ...
    private ArrayList<RejectedModel> rejectedModelArrayList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        survaylist("getAllSurvey",emp_id,"3");
    }
                    ...
                    if (response.isSuccessful()) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < getstatus.length(); i++) {
                                ...
                                rejectedModel.setName(jsonObject.optString("name"));
                                rejectedModel.setHousenumber(jsonObject.getString("house_no"));
                                rejectedModel.setReason(jsonObject.getString("survey_remark"));


                                rejectedModelArrayList.add(rejectedModel);
                            }
                            rejectedAdapter = new RejectedAdapter(getApplicationContext(), rejectedModelArrayList);
                            recycler_view.setAdapter(rejectedAdapter);
